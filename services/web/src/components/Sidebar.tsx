...
export function Sidebar() {
  ...
  return (
    <aside
      className="fixed left-0 top-0 h-screen w-[220px] bg-immich-sidebar border-r border-immich-border flex flex-col"
    ...
    >
      ...
      <div className="p-4 border-b border-immich-border">
        <Link
          to="/"
          className="flex items-center gap-3 text-immich-text"
          aria-label="Home"
        >
